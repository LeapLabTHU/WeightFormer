...
def set_weight_decay_and_lr(
    model, skip_list=(), skip_keywords=(), lower_lr_kvs={}, base_lr=5e-4
):
    # breakpoint()
    ...
    if has_lower_lr:
        result = [
            ...
            {"params": no_decay_low, "weight_decay": 0.0, "lr": lower_lr},
        ]
    else:
        result = [{"params": has_decay}, {"params": no_decay, "weight_decay": 0.0}]
    # breakpoint()
    return result
